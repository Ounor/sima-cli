...
createFile = ({componentName = 'TemplateComponent', componentParams, componentDescription = 'TemplateComponent', componentPath = '', componentExt = []} ) => {
    if (componentName && !componentPath) {
        ...
        fs.appendFile(`./App/Components/${componentPath}/${componentName}.js`, template.componentTemplate(
            ...
            componentParams,
            settings), (e) => {
            console.log(componentName + 'created in' + componentPath)
        })
    }
}
